...
//--------------------------------------------------------------------------------------------------------------------------------
//================================================================================================================================
// 1: This file consists of all of the functions that are used for encryption, converting into 7-bit ascii, decryption. Furthermore
//    this file will also be used for bonus comparision
//================================================================================================================================
...
{
	string filename;
	cout<<"Enter filename without the extension = ";
	cin>>filename;
	filename+=".txt";
...
void decode()
{
	...
	if (in)
	{
		...
		fstream out("reconstructed.txt", ios::out);
		if (out)
		{
...
void equal()
{
	...
	{
		cout << "Both files are not same " << endl << endl;
	}
	else
	{
